...
const HighRiskDashboard: React.FC = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      // If no plan exists, create a default one for high risk
      if (!plan) {
        plan = recoveryPlanService.createRecoveryPlan(user.id, 'high');
      }
    ...
    const sendEmergencyAlert = () => {
      ...
      console.log('SMS sent to emergency contact: +91910397529, +919025363352, +917845272736');
